...
/**
 * Nette Framework (version 2.0-dev released on 2011-08-04, http://nette.org)
 *
...
<div id="netteBluescreen">
	...
	><div>
		...
		<div id="netteBsPnl<?php echo $counter ?>" class="nette-collapsed inner">
			...
			<div class="outer">
			<table id="netteBsPnl<?php echo $counter ?>">
			<?php
			...
			<div class="outer">
			<table id="netteBsPnl<?php echo $counter ?>" class="nette-collapsed">
			<?php
			...
			foreach (ini_get_all() as $k => $v) {
				echo '<tr><th>', htmlspecialchars($k), '</th><td>', htmlspecialchars($v['local_value']), '</th><td>', htmlspecialchars($v['global_value']), "</td></tr>\n";
			}
			?>
			</table>
			</div>
...
final class Framework
{
	...
	const NAME = 'Nette Framework',
		VERSION = '2.0-beta',
		REVISION = '6889b94 released on 2011-08-04';
